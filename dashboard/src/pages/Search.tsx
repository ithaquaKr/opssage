        ...
        {!searched && (
          <Card>
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <p>
                <strong>Semantic Search:</strong> The search uses AI embeddings to
                find contextually relevant documents, not just keyword matches.
              </p>
              <p>
                <strong>Natural Language:</strong> You can use natural language
                queries like "How do I fix database connection issues?"
              </p>
              <p>
                <strong>Collections:</strong> Search different collections for
                specific types of content:
              </p>
              <ul className="ml-6 list-disc space-y-1">
                <li>
                  <strong>Documents:</strong> General technical documentation and
                  guides
                </li>
                <li>
                  <strong>Playbooks:</strong> Incident response procedures and
                  runbooks
                </li>
                <li>
                  <strong>Incidents:</strong> Historical incident reports and
                  post-mortems
                </li>
              </ul>
            </div>
