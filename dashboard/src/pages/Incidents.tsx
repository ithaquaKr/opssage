  ...
  const fetchIncidents = async () => {
    try {
      ...
      const url = filter === 'all'
        ...
        : `${baseUrl}/api/v1/incidents?status=${filter}`
    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-gray-600">
          View and manage all incident analysis reports
        </p>
      </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-2 flex items-center gap-4 text-xs text-gray-500">
                            ...
                            {incident.alert_input.labels.namespace && (
                              <span>Namespace: {incident.alert_input.labels.namespace}</span>
                            )}
                            {incident.alert_input.labels.service && (
                              <span>Service: {incident.alert_input.labels.service}</span>
                            )}
                          ...
                          {incident.diagnostic_report && (
                            <div className="mt-2">
                              ...
                              <p className="text-xs text-gray-500 mt-1">
                                Confidence: {Math.round(incident.diagnostic_report.confidence_score * 100)}%
                              </p>
                            </div>
                          )}
                        </div>
